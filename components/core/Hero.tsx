            ...
            <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white">
                ...
                <main className="flex-1 flex flex-col items-center justify-center text-center relative">
                    ...
                    <div className='mx-52'>
                        ...
                        <h2 className="text-5xl font-medium mb-4 z-10">
                            Revolutionizing travel with <span className="block">AI and personalized experiences</span>
                        </h2>
                        <p className="mb-8 z-10 text-gray-300 font-semibold">
                            Our innovative <span className='text-white'>AI and personalized approach</span> redefines how you explore the world,
                        ...
                        <div className="space-x-2 mb-6 z-10">
                            <input
                                ...
                                className="w-72 px-4 py-2 rounded text-gray-200 bg-black border border-transparent focus:border-white  focus:ring-2 ring-white border-white "
                            />
